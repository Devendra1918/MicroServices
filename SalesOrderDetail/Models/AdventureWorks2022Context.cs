...
namespace SalesOrderDetail.Models;
...
public partial class AdventureWorks2022Context : DbContext
{
    ...
    //    => optionsBuilder.UseSqlServer("Server=OTC2;Database=AdventureWorks2022;Trusted_Connection=True;TrustServerCertificate=True");
